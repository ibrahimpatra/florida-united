        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="card p-6">
            ...
            <div className="grid sm:grid-cols-3 gap-4 mb-4">
              <div>
                ...
                <input {...register('price',{required:'Price required',min:{value:0,message:'Must be ≥ 0'}})} type="number" step="0.01" className="input-field pl-7" placeholder="0.00"/></div>
              </div>
              <div>
                <label className="label">Compare Price</label>
                <div className="relative"><span className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 font-bold">$</span>
                <input {...register('comparePrice')} type="number" step="0.01" className="input-field pl-7" placeholder="0.00"/></div>
              </div>
              <div>
                <label className="label">Cost Price</label>
                <div className="relative"><span className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 font-bold">$</span>
                <input {...register('costPrice')} type="number" step="0.01" className="input-field pl-7" placeholder="0.00"/></div>
              </div>
            </div>
          ...
          <div className="card p-6">
            ...
            <div className="flex gap-2">
              ...
              <button type="button" onClick={()=>{ if(tagInput.startsWith('http')){ setImages(i=>[...i,tagInput]); setTagInput(''); } else addTag(); }}
