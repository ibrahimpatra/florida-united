      ...
      <div className="grid lg:grid-cols-2 gap-10 mb-16">
        ...
        <div>
          ...
          <div className="bg-gray-50 rounded-xl p-4 mb-5 text-sm space-y-1.5">
            ...
            {product.tags?.length > 0 && <div className="flex gap-4"><span className="text-gray-500 w-24">Tags:</span><div className="flex flex-wrap gap-1">{product.tags.map(t => <span key={t} className="badge-gray badge text-xs">{t}</span>)}</div></div>}
          </div>
