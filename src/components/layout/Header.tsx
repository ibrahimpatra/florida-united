...
const categories = [
  {
    ...
    sub: ['Circuit Breakers', 'Wiring & Cable', 'Switches & Outlets', 'Panels & Enclosures', 'Lighting', 'Conduit & Fittings'],
  },
  {
    name: 'Hardware',
    slug: 'hardware',
    icon: <Wrench className="w-4 h-4" />,
    sub: ['Fasteners & Bolts', 'Hand Tools', 'Power Tools', 'Hinges & Locks', 'Anchors', 'Adhesives'],
  },
  {
    name: 'Safety',
    slug: 'safety',
    icon: <Shield className="w-4 h-4" />,
    sub: ['PPE', 'Fire Safety', 'First Aid', 'Safety Signs', 'Harnesses', 'Eye Protection'],
  },
  {
    name: 'Plumbing',
    slug: 'plumbing',
    icon: null,
    sub: ['Pipes & Fittings', 'Valves', 'Faucets', 'Water Heaters', 'Pumps', 'Sealants'],
  },
  {
    name: 'Industrial',
    slug: 'industrial',
    icon: null,
    sub: ['Motors & Drives', 'Pneumatics', 'Hydraulics', 'Bearings', 'Conveyors', 'Material Handling'],
  },
  {
    name: 'Lighting',
    slug: 'lighting',
    icon: null,
    sub: ['LED Fixtures', 'Emergency Lighting', 'Exit Signs', 'Outdoor Lighting', 'Ballasts', 'Bulbs'],
  },
];
              ...
              <div className="relative" ref={dropdownRef}>
                {session ? (
                  ...
                  >
                    ...
                    <span className="text-sm font-medium text-gray-700 hidden md:block">Sign In</span>
                  </Link>
                )}
