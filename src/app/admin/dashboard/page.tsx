...
import { TrendingUp, ShoppingCart, Package, Users, DollarSign, ArrowUpRight, ArrowDownRight, Clock, CheckCircle, AlertTriangle } from 'lucide-react';
...
export default function AdminDashboard() {
  ...
  const statCards = [
    { icon: DollarSign, label:'Total Revenue', value: formatPrice(stats?.totalRevenue||0), change: stats?.revenueChange||0, color:'text-green-600 bg-green-50', href:'/admin/orders' },
        ...
        <div className="lg:col-span-2 card p-6">
          ...
          <ResponsiveContainer width="100%" height={220}>
            <LineChart data={stats?.revenueByDay||[]}>
              ...
              <Tooltip formatter={(v:any,n:string)=>n==='revenue'?[`$${v}`,n]:[v,n]}/>
