...
// Default UOMs — pure data, no Firestore
const DEFAULT_UOMS = [
  { name:'Piece', abbreviation:'pc', isActive:true },
  { name:'Box', abbreviation:'box', isActive:true },
  { name:'Pair', abbreviation:'pr', isActive:true },
  { name:'Pack of 10', abbreviation:'pk10', isActive:true },
  { name:'Pack of 50', abbreviation:'pk50', isActive:true },
  { name:'Dozen', abbreviation:'doz', isActive:true },
  { name:'Roll', abbreviation:'roll', isActive:true },
  { name:'Meter', abbreviation:'m', isActive:true },
  { name:'Kilogram', abbreviation:'kg', isActive:true },
  { name:'Liter', abbreviation:'L', isActive:true },
  { name:'Set', abbreviation:'set', isActive:true },
  { name:'Bundle', abbreviation:'bndl', isActive:true },
];
